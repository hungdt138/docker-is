...
This section defines the step-by-step instructions to build an [Ubuntu](https://hub.docker.com/_/ubuntu/) Linux based Docker image for WSO2 Identity Server 5.10.0.
...
- `docker run -it -p 9443:9443 wso2is:5.10.0`
